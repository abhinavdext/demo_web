...
if(st.button("About")):
    ...
    st.text("To work with perseverance, measuring up to the expectation of the company and Interested to "
             ...
             "Around 5+ years of relevant experience as a Web/Application Developer and coding with analytical
